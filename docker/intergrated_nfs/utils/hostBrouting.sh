...
VIR_ROUTER_B_EXT_IP_V4="fill in"           # IPv4 address of the external router
HOST_B_IP_V4="fill in"                     # IPv4 address of Host B

# HOST B IPv6 info
# 5G_NET_B_CIDR_V6="2001:db8:abcd:003::/64"
# ELK_NET_B_CIDR_V6="2001:db8:abcd:004::/64"
# VIR_ROUTER_B_EXT_IP_V6="fill in"           # IPv6 address of the external router
# HOST_B_IP_V6="fill in"                     # IPv6 address of Host B

# Routing for Host B
ip route add $5G_NET_B_CIDR_V4 via $VIR_ROUTER_B_EXT_IP_V4
ip route add $ELK_NET_B_CIDR_V4 via $VIR_ROUTER_B_EXT_IP_V4
# ip -6 route add $5G_NET_B_CIDR_V6 via $VIR_ROUTER_B_EXT_IP_V6
# ip -6 route add $ELK_NET_B_CIDR_V6 via $VIR_ROUTER_B_EXT_IP_V6